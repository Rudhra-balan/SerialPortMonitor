...
namespace VirtualPortBus
{
    internal class RegistryHelper
    {
        private const string NullModemEmulatorName = "com0com";
        private const string REGISTRY_KEY = @"SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\com0com";
        private const string REGISTRY_KEY_32 = @"SOFTWARE\WOW6432Node\Microsoft\Windows\CurrentVersion\Uninstall\com0com";
