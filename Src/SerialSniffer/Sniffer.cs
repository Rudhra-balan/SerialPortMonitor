namespace SerialSniffer
{
    ...
    public class Sniffer
    {
        ...
        public bool IsOpen => real.IsOpen && simulated.IsOpen;

        public void CloseSniff()
        {
            if (real.IsOpen)
            {
                real.Close();
        ...
        private void ManagePacket(Origin origin, byte[] packet)
        {
            ...
            if (this.IsCollapsingSameOrigin)
            {
                ...
                else
                {
                    ...
                    {
                        SniffedPacketEventArgs eventArgs = new SniffedPacketEventArgs(DateTime.Now, origin, this.bytesArrivedSameOrigin);
