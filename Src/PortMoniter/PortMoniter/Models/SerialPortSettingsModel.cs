...
namespace PortMoniter.Models
{
    ...
    public class SerialPortSettingsModel : SingletonBase<SerialPortSettingsModel>
    {
        ...
        public Handshake FlowControlValue { get; set; }

        public List<SerialPortSettingsModel> getFlowControl()
        {
            List<SerialPortSettingsModel> returnLineEndings = new List<SerialPortSettingsModel>();
            returnLineEndings.Add(new SerialPortSettingsModel() { FlowControlValue = Handshake.None, FlowControlName = "None" });
            returnLineEndings.Add(new SerialPortSettingsModel() { FlowControlValue = Handshake.RequestToSend, FlowControlName = "RequestToSend" });
            returnLineEndings.Add(new SerialPortSettingsModel() { FlowControlValue = Handshake.RequestToSendXOnXOff, FlowControlName = "RequestToSendXOnXOff" });
            returnLineEndings.Add(new SerialPortSettingsModel() { FlowControlValue = Handshake.XOnXOff, FlowControlName = "XOnXOff" });
            return returnLineEndings;
        }
        #endregion
    }
